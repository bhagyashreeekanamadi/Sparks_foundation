...
<body>
    ...
    <div id="title">
        <nav id="navbar" class="navbar navbar-expand-lg navbar-dark ">
            <a id="navbar-brand" href="index.php">Sparks<span>  Foundation</span></a>
    ...
    <div class="container-xl" style="width:30%">
        <form action="payment.php" method="POST">
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" min=0 name="amount" class="form-control" aria-label="Default"
                    aria-describedby="inputGroup-sizing-default" required placeholder="Enter Amount here"
                    oninvalid="this.setCustomValidity('Please Enter Amount')" oninput="this.setCustomValidity('')">
            </div>
